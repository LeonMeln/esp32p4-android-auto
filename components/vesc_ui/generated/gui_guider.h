...
typedef struct
{
	...
	/* Generated setup_scr_dashboard.c references ui->g_kb_top_layer for
	 * every textarea (expects a virtual keyboard pop-up object). The
	 * upstream lv_ui struct in this Super_VESC_Display snapshot was not
	 * regenerated with that member; ta_event_cb in widgets_init.c is
	 * patched to early-return when this is NULL. */
...
/* _grid_480_800x480 dropped from embedded build (1.15 MB, invisible). */
