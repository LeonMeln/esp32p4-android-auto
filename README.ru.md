...
- 🎞️ **Декодирование H.264** через `esp_h264` (SW-декодер) + PPA-ускоренная
  конверсия YUV420 → RGB565 на ESP32-P4. **640×480 @ ~30 fps**, апскейл до
  родного 800×480 экрана.
...
|---|---|---|
| AA Wireless видео (H.264, ~30 fps) | ✅ | Декод 640×480, апскейл до 800×480 через PPA |
